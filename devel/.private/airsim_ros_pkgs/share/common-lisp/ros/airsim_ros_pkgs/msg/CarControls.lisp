...
(cl:defmethod cl:initialize-instance :after ((m <CarControls>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarControls)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-msg:<CarControls> is deprecated: use airsim_ros_pkgs-msg:CarControls instead.")))
...
(cl:defmethod throttle-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:throttle-val is deprecated.  Use airsim_ros_pkgs-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'brake-val :lambda-list '(m))
(cl:defmethod brake-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:brake-val is deprecated.  Use airsim_ros_pkgs-msg:brake instead.")
  (brake m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:steering-val is deprecated.  Use airsim_ros_pkgs-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'handbrake-val :lambda-list '(m))
(cl:defmethod handbrake-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:handbrake-val is deprecated.  Use airsim_ros_pkgs-msg:handbrake instead.")
  (handbrake m))

(cl:ensure-generic-function 'manual-val :lambda-list '(m))
(cl:defmethod manual-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:manual-val is deprecated.  Use airsim_ros_pkgs-msg:manual instead.")
  (manual m))

(cl:ensure-generic-function 'manual_gear-val :lambda-list '(m))
(cl:defmethod manual_gear-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:manual_gear-val is deprecated.  Use airsim_ros_pkgs-msg:manual_gear instead.")
  (manual_gear m))

(cl:ensure-generic-function 'gear_immediate-val :lambda-list '(m))
(cl:defmethod gear_immediate-val ((m <CarControls>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:gear_immediate-val is deprecated.  Use airsim_ros_pkgs-msg:gear_immediate instead.")
  (gear_immediate m))
