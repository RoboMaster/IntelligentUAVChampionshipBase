...
(cl:defmethod cl:initialize-instance :after ((m <Altimeter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Altimeter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-msg:<Altimeter> is deprecated: use airsim_ros_pkgs-msg:Altimeter instead.")))
...
(cl:defmethod pressure-val ((m <Altimeter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:pressure-val is deprecated.  Use airsim_ros_pkgs-msg:pressure instead.")
  (pressure m))

(cl:ensure-generic-function 'qnh-val :lambda-list '(m))
(cl:defmethod qnh-val ((m <Altimeter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:qnh-val is deprecated.  Use airsim_ros_pkgs-msg:qnh instead.")
  (qnh m))
