...
(cl:defmethod cl:initialize-instance :after ((m <Environment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Environment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-msg:<Environment> is deprecated: use airsim_ros_pkgs-msg:Environment instead.")))
...
(cl:defmethod position-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:position-val is deprecated.  Use airsim_ros_pkgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'geo_point-val :lambda-list '(m))
(cl:defmethod geo_point-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:geo_point-val is deprecated.  Use airsim_ros_pkgs-msg:geo_point instead.")
  (geo_point m))

(cl:ensure-generic-function 'gravity-val :lambda-list '(m))
(cl:defmethod gravity-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:gravity-val is deprecated.  Use airsim_ros_pkgs-msg:gravity instead.")
  (gravity m))

(cl:ensure-generic-function 'air_pressure-val :lambda-list '(m))
(cl:defmethod air_pressure-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:air_pressure-val is deprecated.  Use airsim_ros_pkgs-msg:air_pressure instead.")
  (air_pressure m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:temperature-val is deprecated.  Use airsim_ros_pkgs-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'air_density-val :lambda-list '(m))
(cl:defmethod air_density-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:air_density-val is deprecated.  Use airsim_ros_pkgs-msg:air_density instead.")
  (air_density m))
