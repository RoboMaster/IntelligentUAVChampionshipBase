...
(cl:defmethod cl:initialize-instance :after ((m <GimbalAngleQuatCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalAngleQuatCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-msg:<GimbalAngleQuatCmd> is deprecated: use airsim_ros_pkgs-msg:GimbalAngleQuatCmd instead.")))
...
(cl:defmethod orientation-val ((m <GimbalAngleQuatCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-msg:orientation-val is deprecated.  Use airsim_ros_pkgs-msg:orientation instead.")
  (orientation m))
