...
(cl:defmethod cl:initialize-instance :after ((m <PoseCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-msg:<PoseCmd> is deprecated: use airsim_ros_pkgs-msg:PoseCmd instead.")))
