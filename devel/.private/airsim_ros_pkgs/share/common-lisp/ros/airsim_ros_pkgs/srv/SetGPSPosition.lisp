...
(cl:defmethod cl:initialize-instance :after ((m <SetGPSPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGPSPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-srv:<SetGPSPosition-request> is deprecated: use airsim_ros_pkgs-srv:SetGPSPosition-request instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <SetGPSPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-srv:latitude-val is deprecated.  Use airsim_ros_pkgs-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <SetGPSPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-srv:longitude-val is deprecated.  Use airsim_ros_pkgs-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <SetGPSPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros_pkgs-srv:altitude-val is deprecated.  Use airsim_ros_pkgs-srv:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGPSPosition-request>)))
  ...
  "airsim_ros_pkgs/SetGPSPositionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGPSPosition-request)))
  "Returns string type for a service object of type 'SetGPSPosition-request"
  "airsim_ros_pkgs/SetGPSPositionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetGPSPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGPSPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros_pkgs-srv:<SetGPSPosition-response> is deprecated: use airsim_ros_pkgs-srv:SetGPSPosition-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetGPSPosition-response>)))
  ...
  "airsim_ros_pkgs/SetGPSPositionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGPSPosition-response)))
  "Returns string type for a service object of type 'SetGPSPosition-response"
  "airsim_ros_pkgs/SetGPSPositionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetGPSPosition)))
  ...
  "airsim_ros_pkgs/SetGPSPosition")